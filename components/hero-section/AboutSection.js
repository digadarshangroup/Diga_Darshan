      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            ...
            Odisha's most comprehensive business support platform — spanning CA &amp; banking,
            farming &amp; farm construction, real estate, trading, software development,
            entrepreneurship &amp; manufacturing, and product &amp; retail.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-16">
          {[
            { number: "7", label: "Business Domains", icon: "🧭" },
            { number: "1", label: "Single Point of Contact", icon: "🤝" },
            { number: "Multi", label: "Government Schemes Covered", icon: "📋" },
            { number: "Odisha", label: "Local Presence", icon: "📍" },
          ].map((stat, idx) => (
            <motion.div
              key={idx}
              initial={{ opacity: 0, y: 20 }}
