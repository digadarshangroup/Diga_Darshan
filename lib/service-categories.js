...
export const serviceCategories = [
  {
    ...
    hero: {
      odiaTitle: "ଅର୍ଥ",
      headline: "CA, BANKING & LOANS",
      subtitle: "Compliance & Financing",
      bgImage:
        "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-blue-950/80 to-slate-900/90",
      stats: [
        { label: "Filing", value: "ITR" },
        { label: "Registration", value: "GST" },
        { label: "MSME", value: "Udyam" },
        { label: "Finance", value: "Loans" },
      ],
    },
    highlights: [
      { title: "Filings and financing in one place", detail: "Your ITR, GST and Udyam paperwork and your loan application are handled by the same team, so nothing falls between two advisors." },
      { title: "Bank-ready documentation", detail: "Project reports prepared in the format lenders actually accept, which cuts down the back-and-forth on your application." },
      { title: "Deadlines tracked for you", detail: "GST return and ITR due dates are tracked on your behalf so filings don't slip and attract penalties." },
      { title: "Eligibility checked first", detail: "We confirm PMEGP or CGTMSE eligibility before you spend time on an application that won't qualify." },
    ],
    faqs: [
      { q: "Do I need to visit your office to file my ITR?", a: "No. Most filings are handled remotely \u2014 share your documents over WhatsApp or email, and we'll confirm the computation with you before e-filing." },
      { q: "Can you help if I've missed a GST return deadline?", a: "Yes. We'll work out the late fee and interest that apply, file the pending returns, and set up a schedule so it doesn't happen again." },
      { q: "Is Udyam registration really free?", a: "The government charges no fee for Udyam registration itself. Our charge covers handling the process and preparing the documentation." },
    ],
    subcategories: [
      {
        slug: "itr-filing",
  ...
  },
  {
    ...
    hero: {
      odiaTitle: "କୃଷି",
      headline: "FARMING & FARM CONSTRUCTION",
      subtitle: "Aqua, Agri & Livestock",
      bgImage:
        "https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-brand-950/80 to-slate-900/90",
      stats: [
    ...
    highlights: [
      { title: "Farm, pond and shed together", detail: "Agriculture, aquaculture and animal husbandry alongside the construction that supports them \u2014 planned as one project, not three." },
      { title: "Scheme matched before you build", detail: "We identify which subsidy schemes apply first, so the project is designed to qualify rather than retrofitted later." },
      { title: "Site assessed first", detail: "Land, water access and soil conditions are checked before we recommend an activity or a budget." },
      { title: "Field presence across Odisha", detail: "Site visits and surveys in your district, not advice from a distance." },
    ],
    faqs: [
      { q: "Do I need to own the land?", a: "Not always. Many schemes accept a registered lease agreement. We'll confirm what your specific scheme requires before you apply." },
      { q: "Can you handle both the pond and the subsidy application?", a: "Yes. Construction and scheme facilitation are handled by the same team, so the build matches what the scheme expects." },
      { q: "What if my land turns out not to be suitable?", a: "We'll tell you at the assessment stage and suggest alternatives, rather than proceed with a project that is unlikely to work." },
    ],
    subcategories: [
      {
  ...
  },
  {
    ...
    hero: {
      ...
      bgImage:
        "https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-amber-950/80 to-slate-900/90",
      stats: [
        { label: "Land", value: "Plots" },
        { label: "Projects", value: "Residential" },
        { label: "Spaces", value: "Commercial" },
        { label: "Advisory", value: "Property" },
      ],
    },
    highlights: [
      { title: "Title checked before you commit", detail: "Ownership and land documents are verified as part of the process, not left for you to chase." },
      { title: "Approvals pursued for you", detail: "Layout and statutory approvals are followed up with the local authority through to sanction." },
      { title: "Build, buy or lease", detail: "Development, purchase advisory and leasing handled by one team instead of three intermediaries." },
      { title: "An independent view", detail: "Honest guidance on whether a property actually fits your budget and your goals." },
    ],
    faqs: [
      { q: "Do you handle approvals or only construction?", a: "Both. We prepare and pursue layout and plan approvals with the local authority, and coordinate the build itself." },
      { q: "Can you verify a property I've already found?", a: "Yes. Title and document due diligence is available on its own, without you committing to anything further." },
      { q: "How long do layout approvals usually take?", a: "Typically 4-12 weeks, depending on the authority involved and how complete the land documents are." },
    ],
    subcategories: [
      {
  ...
  },
  {
    ...
    hero: {
      odiaTitle: "ବାଣିଜ୍ୟ",
      headline: "TRADING HUB",
      subtitle: "Financial Education",
      bgImage:
        "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-violet-950/80 to-slate-900/90",
      stats: [
    ...
    highlights: [
      { title: "A curriculum, not tips", detail: "Structured modules that build from market fundamentals upward \u2014 this is training, not a buy/sell signals service." },
      { title: "Risk management throughout", detail: "Position sizing and capital protection are taught from the start, not added at the end as a footnote." },
      { title: "Guided live practice", detail: "Supervised live-market sessions so you apply what you have learned with someone watching." },
      { title: "Mentor access", detail: "One-on-one review of your own trades, decisions and trading psychology." },
    ],
    faqs: [
      { q: "Do I need prior market experience?", a: "No. Courses start from the fundamentals \u2014 order types, charts and terminology \u2014 before moving on to strategy." },
      { q: "Do you provide buy and sell tips?", a: "No. We teach you to make your own decisions. We do not run a tips, signals or portfolio management service." },
      { q: "How much capital do I need to start?", a: "You can complete the learning without putting live capital at risk. Capital planning is covered as part of the course." },
    ],
    href: "/trading",
    subcategories: [
      {
  ...
  },
  {
    ...
    hero: {
      ...
      subtitle: "Web, Apps & Systems",
      bgImage:
        "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-indigo-950/80 to-slate-900/90",
      stats: [
        { label: "Web", value: "Websites" },
        { label: "Mobile", value: "Apps" },
        { label: "Systems", value: "ERP" },
        { label: "Growth", value: "SEO" },
      ],
    },
    highlights: [
      { title: "Built around how you work", detail: "We map your actual workflow and pain points before proposing a system, so the software fits the business." },
      { title: "Mobile-first by default", detail: "Sites and apps built for the devices your customers actually use, not desktop designs shrunk down." },
      { title: "Handover, not lock-in", detail: "You get access and basic training so you can manage your own content instead of paying for every text change." },
      { title: "Support after launch", detail: "We stay available once the site is live, not only until go-live day." },
    ],
    faqs: [
      { q: "Do I own the website or app?", a: "Yes. The domain, the content and the delivered product are yours." },
      { q: "Can you update my existing site instead of rebuilding it?", a: "Often, yes. We'll review what you have and tell you honestly whether updating or rebuilding is better value for you." },
      { q: "How long does a business website take?", a: "Typically 2-6 weeks, depending on how many pages and features are involved." },
    ],
    subcategories: [
      {
  ...
  },
  {
    ...
    hero: {
      odiaTitle: "ଉଦ୍ୟୋଗ",
      headline: "ENTREPRENEUR & MANUFACTURING",
      subtitle: "Business Development",
      bgImage:
        "https://images.unsplash.com/photo-1556761175-b413da4baf72?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-rose-950/80 to-slate-900/90",
      stats: [
        { label: "Scheme", value: "PMEGP" },
        { label: "Reports", value: "DPR" },
        { label: "Setup", value: "Unit" },
        { label: "Support", value: "E2E" },
      ],
    },
    highlights: [
      { title: "Idea through to working unit", detail: "Advisory, project report, scheme application and physical setup handled end to end by one team." },
      { title: "Bank-ready project reports", detail: "DPRs written in the format lenders expect, with costing and projections that stand up to appraisal." },
      { title: "Scheme-first planning", detail: "PMEGP, CGTMSE and other schemes are checked for eligibility before you commit money or time." },
      { title: "Vendor coordination", detail: "Machinery specification and supplier coordination during setup, so you are not managing it alone." },
    ],
    faqs: [
      { q: "Is PMEGP available for an existing business?", a: "No \u2014 PMEGP is for new units only. If your unit is already operating we'll point you to schemes that do apply." },
      { q: "Do you only prepare the report, or help with the loan too?", a: "Both. We prepare the DPR and then follow up with the bank through appraisal and sanction." },
      { q: "What is the minimum project size you take on?", a: "There is no fixed minimum. We'll advise based on your activity, budget and the scheme you are applying under." },
    ],
    subcategories: [
      {
  ...
  },
  {
    ...
    hero: {
      odiaTitle: "ବ୍ୟବସାୟ",
      headline: "PRODUCT & RETAIL",
      subtitle: "Stores & E-commerce",
      bgImage:
        "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=75&w=1600&auto=format&fit=crop",
      overlay: "from-slate-900/80 via-teal-950/80 to-slate-900/90",
      stats: [
        { label: "Setup", value: "Store" },
        { label: "Network", value: "Distribution" },
        { label: "Model", value: "Franchise" },
        { label: "Online", value: "E-commerce" },
      ],
    },
    highlights: [
      { title: "Store to shelf", detail: "Location, licensing, store setup and distribution planned together rather than as separate errands." },
      { title: "Online and offline", detail: "Marketplace onboarding runs alongside physical retail setup, so both channels launch coherently." },
      { title: "Licensing sorted", detail: "The local trade licences and registrations you need are identified and applied for on your behalf." },
      { title: "Franchise due diligence", detail: "An independent review of the agreement and the opportunity before you sign anything." },
    ],
    faqs: [
      { q: "Do you help with GST for selling on marketplaces?", a: "Yes. GST registration is required for most marketplace onboarding, and we handle it as part of the setup." },
      { q: "Can you help me find distributors?", a: "Yes. Distribution network planning and onboarding of distributors and retailers are part of the service." },
      { q: "Do I need a physical store to sell online?", a: "No. E-commerce and marketplace setup can be done entirely independently of a physical store." },
    ],
    subcategories: [
      {
